...
import FeedMonitor from "./components/dashboard/FeedMonitor";
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <nav className="bg-white/90 backdrop-blur-md sticky top-0 z-20 px-8 py-2 flex border-b border-gray-200 shadow-md transition-all duration-300">
        <div className="flex space-x-2">
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "dashboard" 
          ...
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "data" 
                ? "text-white bg-gradient-to-r from-green-600 to-emerald-600 shadow-lg hover-lift" 
          ...
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "test" 
                ? "text-white bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg hover-lift" 
          ...
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "gate" 
                ? "text-white bg-gradient-to-r from-orange-600 to-red-600 shadow-lg hover-lift" 
          ...
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "environment" 
                ? "text-white bg-gradient-to-r from-cyan-600 to-blue-600 shadow-lg hover-lift" 
          ...
          <button 
            className={`px-6 py-3 font-bold transition-all duration-300 relative rounded-lg group ${
              activeTab === "feed" 
                ? "text-white bg-gradient-to-r from-yellow-600 to-green-600 shadow-lg hover-lift" 
                : "text-gray-700 hover:text-green-600 hover:bg-green-50"
            }`}
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-slate-900 to-gray-900 text-white text-center py-8 px-8 relative overflow-hidden shadow-2xl border-t border-gray-700">
        <div className="absolute inset-0 overflow-hidden opacity-30">
          <div className="absolute bottom-0 left-1/4 w-full h-40 bg-blue-500 rounded-full filter blur-3xl transform -translate-y-1/2 animate-pulse"></div>
          <div className="absolute top-0 right-1/4 w-full h-40 bg-purple-500 rounded-full filter blur-3xl transform translate-y-1/2 animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center text-xs text-gray-300 space-x-6 gap-y-2 mb-4">
            <div className="flex items-center">
